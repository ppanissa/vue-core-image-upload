...
if (false) {(function () {  module.hot.accept()
  ...
  var id = "_v-1ada1458/resize-bar.vue"
  if (!module.hot.data) {
  ...
  methods: {
    ...
    change: function change(e) {
      ...
      if (this.compress && this.files[0]['type'] !== 'image/png' && this.files[0]['type'] !== 'image/gif') {
        _daycaca2.default.compress(file, 100 - this.compress, function (code) {
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-rewriter.js!./style.css", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-rewriter.js!./style.css");
...
var _resize2 = __webpack_require__(23);
...
// module
exports.push([module.i, ".g-crop-image-principal[_v-6104acee]{\n    overflow: hidden;\n    position: relative;\n    background-color: #fff;\n    background-image: linear-gradient(to top right, #efefef 25%, transparent 25%, transparent 75%, #efefef 75%, #efefef),linear-gradient(to top right, #efefef 25%, transparent 25%, transparent 75%, #efefef 75%, #efefef);\n    background-position: 0 0,10px 10px;\n    background-size: 21px 21px;\n  }\n  .image-aside[_v-6104acee]{\n    overflow: hidden;\n    position: absolute;\n    right: 30px;\n    left:30px;\n    top:70px;\n    bottom:40px;\n    text-align: center;\n  }\n  .image-aside .image-wrap[_v-6104acee]{\n    position: absolute;\n    left: 0;\n    top: 0;\n    -webkit-touch-callout: none;\n    -webkit-user-select: none;\n    -moz-user-select: none;\n    -ms-user-select: none;\n    user-select: none;\n    box-shadow: 0 3px 5px -2px rgba(0,0,0,.25);\n    background-size: cover;\n  }\n  .image-mask[_v-6104acee]{\n    position: absolute;\n    left: 0;\n    top: 0;\n    width:100%;\n    height: 100%;\n  }\n  .image-mask .mask[_v-6104acee] {\n    position: absolute;\n    background-color: rgba(255,255,255,.6);\n  }\n  .crop-box[_v-6104acee]{\n    z-index: 2000;\n    box-sizing: border-box;\n    position: absolute;\n    background: none;\n    cursor: move;\n    width:100px;\n    height: 100px;\n    border:1px solid rgba(255,255,255, .95);\n  }\n  .crop-box[_v-6104acee]:after,\n  .crop-box[_v-6104acee]:before{\n    content: '';\n    display: block;\n    opacity: 0;\n    position: absolute;\n    left: 33.3333%;\n    top: 0;\n    width: 33.334%;\n    height: 100%;\n    background-color: transparent;\n    border-color: rgba(255,255,255,.7);\n    border-style: solid;\n    border-width: 0;\n  }\n  .crop-box[_v-6104acee]:active::before,\n  .crop-box[_v-6104acee]:active::after{\n    opacity: 1;\n  }\n  .crop-box[_v-6104acee]:before{\n    border-left-width: 1px;\n    border-right-width: 1px;\n  }\n  .crop-box[_v-6104acee]:after{\n    top: 33.3333%;\n    left: 0;\n    height: 33.3334%;\n    width: 100%;\n    border-top-width: 1px;\n    border-bottom-width: 1px;\n  \n  }\n  .crop-box .g-resize[_v-6104acee]{\n    display: inline-block;\n    z-index: 1910;\n    position: absolute;\n    bottom: -8px;\n    right: -8px;\n    width: 16px;\n    height: 16px;\n    cursor: se-resize;\n    border-radius: 10px;\n    background-color: #fff;\n    box-shadow: 0 2px 4px -2px rgba(0,0,0,.25);\n  }\n", ""]);
...
module.exports = "\n<div class=\"g-resize-bar\" _v-1ada1458=\"\">\n  <div class=\"g-resize-highlight\" :style=\"{width: left + '%',}\" _v-1ada1458=\"\"></div>\n  <button class=\"circle-btn\" @touchstart.self=\"drag\" @mousedown.self=\"drag\" :style=\"{left: left + '%',}\" _v-1ada1458=\"\"></button>\n</div>\n";

/***/ }),
/* 102 */
/***/ (function(module, exports) {

module.exports = "\n<div class=\"image-aside\" _v-6104acee=\"\">\n  <div class=\"g-crop-image-box\" _v-6104acee=\"\">\n    <div class=\"g-crop-image-principal\" @touchstart=\"drag\" @mousedown=\"drag\" _v-6104acee=\"\">\n      <div class=\"image-wrap\" :style=\"{ width: width + 'px',height: height + 'px', left: left+ 'px', top: top + 'px', backgroundImage: 'url(' + src + ')', cursor: isResize ? 'default' : 'move'}\" _v-6104acee=\"\">\n        <img ref=\"crop-image\" style=\"width:0;height:0;\" :src=\"src\" _v-6104acee=\"\">\n      </div>\n      <div class=\"image-mask\" v-if=\"!isResize\" _v-6104acee=\"\">\n        <div class=\"mask top\" :style=\"{ top:0, height: cropCSS.top + 'px', left: 0, width: '100%'}\" _v-6104acee=\"\"></div>\n        <div class=\"mask bottom\" :style=\"{ bottom:0, top: (cropCSS.top + cropCSS.height) + 'px', left: 0, width: '100%'}\" _v-6104acee=\"\"></div>\n        <div class=\"mask left\" :style=\"{top: cropCSS.top + 'px', height: cropCSS.height + 'px', left:0, width: cropCSS.left + 'px'}\" _v-6104acee=\"\"></div>\n        <div class=\"mask right\" :style=\"{top: cropCSS.top + 'px', height: cropCSS.height + 'px', left: (cropCSS.left + cropCSS.width) + 'px', right: 0}\" _v-6104acee=\"\"></div>\n      </div>\n      <div class=\"crop-box\" v-if=\"!isResize\" :style=\"{top: cropCSS.top + 'px', left: cropCSS.left + 'px', height: cropCSS.height + 'px',  width: cropCSS.width + 'px'}\" _v-6104acee=\"\">\n        <div class=\"reference-line v\" _v-6104acee=\"\"></div>\n        <div class=\"reference-line h\" _v-6104acee=\"\"></div>\n        <a class=\"g-resize\" @touchstart.self=\"resize\" @mousedown.self=\"resize\" _v-6104acee=\"\"></a>\n      </div>\n    </div>\n    <resize-bar v-if=\"resize\" ref=\"resizeBar\" @resize=\"resizeImage\" _v-6104acee=\"\"></resize-bar>\n    <rotate-bar v-if=\"isRotate\" @rotate=\"rotateImage\" _v-6104acee=\"\"></rotate-bar>\n  </div>\n</div>\n";
...
if (false) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), false)
  if (!hotAPI.compatible) return
  var id = "_v-12cbbdff/rotate-bar.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, __vue_template__)
...
if (false) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), false)
  if (!hotAPI.compatible) return
  var id = "_v-388b382c/vue-core-image-upload.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, __vue_template__)
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../node_modules/css-loader/index.js!../node_modules/vue-loader/lib/style-rewriter.js!../node_modules/vue-loader/lib/selector.js?type=style&index=0!./rotate-bar.vue", function() {
			var newContent = require("!!../node_modules/css-loader/index.js!../node_modules/vue-loader/lib/style-rewriter.js!../node_modules/vue-loader/lib/selector.js?type=style&index=0!./rotate-bar.vue");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../node_modules/css-loader/index.js!../node_modules/vue-loader/lib/style-rewriter.js?id=_v-1ada1458&scoped=true!../node_modules/vue-loader/lib/selector.js?type=style&index=0!./resize-bar.vue", function() {
			var newContent = require("!!../node_modules/css-loader/index.js!../node_modules/vue-loader/lib/style-rewriter.js?id=_v-1ada1458&scoped=true!../node_modules/vue-loader/lib/selector.js?type=style&index=0!./resize-bar.vue");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-6104acee&scoped=true!./crop.css", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-6104acee&scoped=true!./crop.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
